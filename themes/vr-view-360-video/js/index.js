	...
	if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
		...
		if (typeof obj["video-spheres"] !== "undefined") {
			for (var i = 0; i < obj["video-spheres"].length; i++) {
				...
				scenes[
					obj["video-spheres"][i]["video-sphere"][
						"#content-id"
					]
				] = videosphere;
			}
		...
		if (
			typeof obj["video-spheres"] !== "undefined" &&
			obj["video-spheres"].length > 0
		) {
			...
			vrView = new VRView.Player("#vrview", {
				video:
					obj["video-spheres"][0]["video-sphere"][
						"#uri"
					]["#value"],
				default_yaw: 0,
				is_debug: false,
